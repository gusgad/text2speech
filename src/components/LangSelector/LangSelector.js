...
export const LanguageSelector = (props) => (
    <div className='LanguageSelector-container'>
        <select onChange={props.langChange} className={props.langWarning ? 'LanguageSelector-input LanguageSelector-input-warning' : 'LanguageSelector-input'} value={props.selectedLang}>
